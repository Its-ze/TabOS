...
- Base-system IMU/gyro sampling for diagnostics; display rotation is locked pending hardware tuning.
...
- Device shows the TabOS `0.5.4-m5` splash screen on boot.
...
- Display stays locked in landscape while gyro readings remain visible in Sensors.
...
- Sensors app shows temperature, humidity, light, voltage, gyro, and rotation state.
