...
- Display rotation, animation wipes, and screen dim/off are locked down pending hardware tuning.
...
- Device shows the TabOS `0.5.5-m5` splash screen on boot.
...
- Display stays locked in landscape with no transition wipe animation.
